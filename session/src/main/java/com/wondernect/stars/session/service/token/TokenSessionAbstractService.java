package com.wondernect.stars.session.service.token;
 ...
 * Description:
 */
public abstract class TokenSessionAbstractService extends BaseTokenService<TokenResponseDTO, TokenSession> implements TokenSessionInterface {
