...
import com.wondernect.stars.session.service.InitCodeSessionService;
 ...
 * Description:
 */
public abstract class AbstractCodeSessionService extends BaseCodeService<CodeResponseDTO, CodeSession> implements InitCodeSessionService {
