...
public class DatabaseUserManageController {
    ...
    public BusinessData<List<ESExcelItem>> excelItemList() {
        return new BusinessData<>(databaseUserManageService.excelItemList());
    }
    ...
    public void excelDataExport(
        ...
        databaseUserManageService.excelDataExport(exportServiceIdentifier, listDatabaseUserManageRequestDTO, request, response);
    }
