...
public interface DatabaseUserManageFeignClient {
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/create")
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/{id}/update")
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/{id}/delete")
    BusinessData delete(
            @ApiParam(required = true) @NotBlank(message = "对象id不能为空") @PathVariable(value = "id", required = false) String id
    );

    @ApiOperation(value = "获取详细信息", httpMethod = "GET")
    @GetMapping(value = "/v1/wondernect/database_user_manage/{id}/detail")
    BusinessData<DatabaseUserManageResponseDTO> detail(
            @ApiParam(required = true) @NotBlank(message = "对象id不能为空") @PathVariable(value = "id", required = false) String id
    );

    @ApiOperation(value = "列表", httpMethod = "POST")
    @PostMapping(value = "/v1/wondernect/database_user_manage/list")
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/{type}/give_rights")
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/revoke_rights")
    BusinessData<DatabaseUserManageResponseDTO> revokeRights(
            @ApiParam(required = true) @NotNull(message = "请求参数不能为空") @Validated @RequestBody(required = false) DatabaseUserRequestDTO databaseUserRequestDTO
    );

    @ApiOperation(value = "测试连接", httpMethod = "POST")
    @PostMapping(value = "/v1/wondernect/database_user_manage/test_connect")
    ...
    @PostMapping(value = "/v1/wondernect/database_user_manage/modify_password")
