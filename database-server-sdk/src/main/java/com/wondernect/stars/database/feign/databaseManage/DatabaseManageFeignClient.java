...
public interface DatabaseManageFeignClient {
    ...
    @PostMapping(value = "/v1/wondernect/database/database_manage/create")
    ...
    @PostMapping(value = "/v1/wondernect/database/database_manage/{id}/update")
    ...
    @PostMapping(value = "/v1/wondernect/database/database_manage/{id}/delete")
    BusinessData delete(
            @ApiParam(required = true) @NotBlank(message = "对象id不能为空") @PathVariable(value = "id", required = false) String id
    );

    @ApiOperation(value = "获取详细信息", httpMethod = "GET")
    @GetMapping(value = "/v1/wondernect/database/database_manage/{id}/detail")
    BusinessData<DatabaseManageResponseDTO> detail(
            @ApiParam(required = true) @NotBlank(message = "对象id不能为空") @PathVariable(value = "id", required = false) String id
    );

    @ApiOperation(value = "列表", httpMethod = "POST")
    @PostMapping(value = "/v1/wondernect/database/database_manage/list")
    ...
    @PostMapping(value = "/v1/wondernect/database/database_manage/page")
    ...
    @PostMapping(value = "/v1/wondernect/database/database_manage/init_database")
