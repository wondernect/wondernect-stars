...
@ConfigurationProperties(prefix = "wondernect.stars.rbac.feign")
public class WondernectRbacFeignConfigProperties implements Serializable {

    private static final long serialVersionUID = -8120698783277706219L;

    private String name = "wondernect-stars-rbac"; // 远程服务name
