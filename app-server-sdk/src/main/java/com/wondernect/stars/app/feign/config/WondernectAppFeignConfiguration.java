 ...
 */
@Configuration
@EnableConfigurationProperties(WondernectAppFeignConfigProperties.class)
public class WondernectAppFeignConfiguration implements RequestInterceptor {

    private static final Logger logger = LoggerFactory.getLogger(WondernectAppFeignConfiguration.class);

    @Autowired
    private WondernectAppFeignConfigProperties wondernectUserFeignConfigProperties;
