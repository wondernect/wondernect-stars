package com.wondernect.stars.sms.feign.config;
...
@ConfigurationProperties(prefix = "wondernect.stars.sms.feign")
public class WondernectSmsFeignConfigProperties implements Serializable {
